...
std::expected<void, ApplyError> OrderBook::apply(const fink::market::BookUpdate& update) {
...
bool OrderBook::symbol_is_compatible(const fink::core::Symbol& symbol) const noexcept {
