...
TEST(OrderBookTests, AppliesSnapshotAndCalculatesTopSpreadAndMidPrice) {
    ...
    BookSnapshot snapshot{
        ...
        .bids = {
            BookLevel{.price = Price{100.0}, .quantity = Quantity{2.0}},
            BookLevel{.price = Price{99.0}, .quantity = Quantity{3.0}}
        },
        .asks = {
            BookLevel{.price = Price{101.0}, .quantity = Quantity{1.5}},
...
TEST(OrderBookTests, AppliesIncrementalUpdateAndRemovesLevelWithZeroQuantity) {
    ...
    BookSnapshot snapshot{
        ...
        .asks = {
            BookLevel{.price = Price{101.0}, .quantity = Quantity{1.0}}
        }
    };
    ...
    BookUpdate update{
        ...
        .bids = {
            BookLevel{.price = Price{100.0}, .quantity = Quantity{0.0}},
